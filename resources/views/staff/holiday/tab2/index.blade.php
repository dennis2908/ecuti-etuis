...
<div class=" container-fluid container-fixed-lg bg-white">
	...
	<div class="card card-transparent mb-0 mt-3">
		<form class="p-b-10" id="form-specific" role="form" autocomplete="off" method="post" action="{{ route('staff.holiday.specific') }}" novalidate>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
				<form id="form-add-specific" role="form" method="post" action="{{ route('staff.holiday.specific') }}">
...
var settings2 = {
	...
	"serverSide": true,
	"deferRender": true,
	"ajax": "{{ route('staff.holiday.specific') }}",
	"columns": [
...
function editSpecific(id) {
	$("#modal-div").load("{{ route('staff.holiday.specific') }}/"+id);
}
...
function removeSpecific(id) {
	...
	.then((confirm) => {
		if (confirm) {
			$.ajax({
				url: '{{ route('staff.holiday.specific') }}/'+id,
				method: 'delete',
				dataType: 'json',
				async: true,
				contentType: false,
