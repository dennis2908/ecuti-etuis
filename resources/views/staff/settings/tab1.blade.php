...
<div class=" container-fluid container-fixed-lg bg-white">
	...
	<div class="card card-transparent">
		<div class="card-block">
			<form class="form-horizontal" role="form" autocomplete="off" method="post" action="{{ route('staff.settings') }}">
				...
				@include('components.bs.radio', [
					'name' => 'APP_DEBUG',
					'label' => 'Mod Debug',
					'info' => 'Mod DEBUG akan membenarkan pentadbir/staffistrator untuk melihat log masalah yang sedang dihadapi dengan lebih terperinci.',
					'mode' => 'required',
					'data' => [
						'true' => 'Aktif', 
						'false' => 'Tidak Aktif',
